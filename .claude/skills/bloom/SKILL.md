---
name: bloom
description: Per-session sticky mode that makes markdown bloom into rich, self-contained .html artifacts. Activate /bloom, deactivate /bloom-off. Once on, stays on for the session.
---
